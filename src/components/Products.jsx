  ...
  const products = [
    {
      ...
      price: '15,000',
      image: '/src/assets/images/Eoi9iKAisxW6.jpg',
    ...
    },
    {
      ...
      price: '8,500',
      image: '/src/assets/images/5orAehTZDESL.webp',
    ...
    },
    {
      ...
      price: '2,800',
      image: '/src/assets/images/mkzA9UcxUyM0.jpg',
    ...
    },
    {
      ...
      category: 'home-furniture',
      price: '12,000',
      image: '/src/assets/images/7vZDGNzx3tiS.jpg',
    ...
    },
    {
      ...
      category: 'office-furniture',
      price: '1,200',
      image: '/src/assets/images/SI4el2FwFutE.webp',
    ...
    },
    {
      ...
      category: 'air-conditioners',
      price: '1,500',
      image: '/src/assets/images/EpVYHBMNDlhz.jpg',
    ...
    <section id="products" className="py-20 bg-gray-900">
      <div className="container mx-auto px-4">
            ...
            >
              ...
              <div className="p-6">
                ...
                <div className="flex items-center justify-between">
                  ...
                  <button className="bg-primary text-black px-4 py-2 rounded-lg font-semibold hover:bg-yellow-400 transition-colors flex items-center gap-2">
                    طلب الآن
                    <ArrowLeft size={16} />
                  </button>
                </div>
        ...
        <div className="text-center mt-12">
          <button className="bg-transparent border-2 border-primary text-primary px-8 py-4 rounded-lg font-bold text-lg hover:bg-primary hover:text-black transition-all duration-300">
            عرض جميع المنتجات
          </button>
        </div>
      </div>
